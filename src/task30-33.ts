...
function welcomeName(name : string = "Guest"): string {
    return `Welcome, ${name}!`;
}
console.log(welcomeName());
console.log(welcomeName("山田"));

console.log("2. 2つの数値を引数として受け取り、2番目の引数のデフォルト値を10に設定して、それらを掛け算する関数を作成してください。")
function multiplyNumber(num1: number, num2: number = 10) {
    return num1 * num2
}
...
function multiplyOrReturn(num1: number, num2?: number): number {
    return num2 !== undefined ? num1 * num2 : num1;
}
console.log(multiplyOrReturn(2,4));
console.log(multiplyOrReturn(2));
